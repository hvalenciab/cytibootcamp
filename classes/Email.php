...
class Email {
    ...
    public function enviarConfirmacion() {
         ...
         $mail->setFrom('registros@cytibootcamp.com');
    ...
    public function enviarInstrucciones() {
        ...
        $mail->setFrom('registro@cytibootcamp.com');
        $mail->addAddress($this->email, $this->nombre);
        ...
        $contenido .= "<p>Presiona aquí para: <a href='" . $_ENV['HOST'] . "/reestablecer?token=" . $this->token . "'>Reestablecer tu password</a>";        
